...
def get_DNN(num):
    ...
    checkpoint_path = "checkpoint_96000.pth.tar"
...
def get_data(file_path):
    with open(file_path, 'r', encoding='utf-8') as f:
        lines = f.readlines()
    data_list = [text.text_to_sequence(line.strip(), hp.text_cleaners) for line in lines]
    return data_list
...
if __name__ == "__main__":
    ...
    data_list = get_data("/home/whr-a/TTS/data.txt")
